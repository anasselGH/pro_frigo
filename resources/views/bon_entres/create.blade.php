...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Ajouter Bon d'Entrée</h2>
            </div>
            <div class="pull-right mb-2">
                <a class="btn btn-primary" href="{{ route('bon_entres.index') }}"> Retour</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('bon_entres.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_entre" class="form-control" placeholder="Date Entrée">
                </div>
                <div class="form-group">
                    <strong>Date Sortie:</strong>
                    <input type="date" name="date_sortie" class="form-control" placeholder="Date Sortie">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <table class="table table-bordered" id="dynamicAddRemove">
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="details[0][prix]" class="form-control" /></td>
                            <td>
