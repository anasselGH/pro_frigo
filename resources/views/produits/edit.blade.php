        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="designation" value="{{ $produit->designation }}" class="form-control" placeholder="Désignation">
                </div>
                <div class="form-group">
                    ...
                    <select name="famille_id" class="form-control">
                        ...
                        @foreach ($familles as $famille)
                            <option value="{{ $famille->id }}" {{ $produit->famille_id == $famille->id ? 'selected' : '' }}>
                                {{ $famille->famille }}
                            </option>
                        @endforeach
                    </select>
